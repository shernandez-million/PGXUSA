...
REPL = [
    ...
    ('<a class="lang" href="{{ALT_URL}}" lang="es" hreflang="es" aria-label="Ver esta página en español">ES</a>',
     '<a class="lang" href="{{ALT_URL}}" lang="en" hreflang="en" aria-label="View this page in English">EN</a>', 1),
    ('<a class="skip" href="#top">Skip to content</a>',
     '<a class="skip" href="#top">Ir al contenido</a>', 1),
    ...
    ('Construction</h3><p>Scheduled trades, daily supervision, weekly updates with photos, and inspections we prepare for and attend in person.</p><span class="t">Per scope</span>',
     'Construcción</h3><p>Oficios programados, supervisión diaria, reportes semanales con fotos e inspecciones que preparamos y atendemos en persona.</p><span class="t">Según alcance</span>', 1),
    ...
    ('© 2026 PGX Builders Group LLC · Lic. CGC1539072 · Licensed &amp; insured · Images are architectural renderings',
     '© 2026 PGX Builders Group LLC · Lic. CGC1539072 · Licenciado y asegurado · Las imágenes son renders arquitectónicos', 1),
